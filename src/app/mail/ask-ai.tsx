...
const AskAI = ({ isCollapsed }: { isCollapsed: boolean }) => {
  ...
  return (
    <div className="mb-14 p-4">
      <motion.div className="pb- flex flex-1 flex-col items-end rounded-lg bg-gray-100 p-4 shadow-inner dark:bg-gray-900">
        <div
                ...
                >
                  <div className="px-3 py-2 text-[15px] leading-[15px]">
                    {message.parts?.length > 0 ? (
                      ...
                      // Fallback for older message format or debugging
