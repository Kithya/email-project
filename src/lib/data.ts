...
export const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "Hotlink all Operations Buttons",
      "All integrations & Support from Team",
      "Custom Tone Training",
      "Team Disabled Language Support in email workflow",
      "Support very email and Organizations",
    ],
    buttonText: "Choose $4 / Month",
